...
switch( $action ){
  case "login":
	...
	case "changePassword":
		...
		break;
	case "checkLogin":
		echo json_encode($access->isLoggedIn( $_POST["userId"], $_POST["secret"] ));
	break;
	case "getUsers":
	...
	case "getDatasets":
		...
		break;
	case "editDataset":
		echo $access->editDataset( $_POST["userId"], $_POST["name"], $_POST["public"] )->asJson();
		break;
	case "uploadDataset":
		echo $access->uploadDataset( $_POST["userId"], $_POST["secret"], $_POST["name"], $_POST["pub"], $_POST["dataset"])->asJson();
		break;
	case "deleteDataset":
